    ...
    return currentUser== null?const  SizedBox() :  ref.watch(userDetailsProvider(tweet.uid)).when(
        data: (user) {
          return GestureDetector(
            onTap: (() {
              Navigator.push(context, TweeterReplyScreen.route(tweet));
            }),
            child: Column(
              children: [
                Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              style: const TextStyle(color:Pallete.greyColor,fontSize: 16,fontWeight: FontWeight.w500),)
                            ],
                          ),
                          Row(
                            children: [
                                  ...
                                  countBuilder: (likeCount, isLiked, text) {
                                    return Padding(
                                      ...
                                      child: Text(text,style:TextStyle(
                                        color:isLiked?Pallete.redColor:Pallete.whiteColor,fontSize: 16
                                      ),),
                                    );
                                  },
                                ),
