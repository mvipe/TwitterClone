        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              RichText(text: TextSpan(text: "Already have an account",style: const TextStyle(fontSize: 16),
                children: [
                  TextSpan(text: " Sign in",style: const TextStyle(color: Pallete.blueColor,fontSize: 16),
